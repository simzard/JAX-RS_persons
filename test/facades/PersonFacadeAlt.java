 ...
 * @author simon
 */
public class PersonFacadeAlt implements IPersonFacade {

    @PersistenceContext(name = "persistence/testing", unitName = "JAX-RS_personsPU2")
    EntityManager em;

    private EntityManagerFactory emf;

    public PersonFacadeAlt(EntityManagerFactory emf) {
        this.emf = emf;
    }
